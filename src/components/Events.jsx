          ...
          <div className='container'>
            <div className="row">
              ...
              <div className="custom-block-info eventContent pe-5">
                    <Link to="#" className="events-title mb-3 text-dark-emphasis fs-2">Private activities</Link>

                    <p className="text-dark-emphasis">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>

                    <div className="d-flex flex-wrap border-top mt-4 pt-3">

                        <div className="mb-4 mb-lg-0">
                            <div className="d-flex flex-wrap align-items-center mb-1">
                                <span className="custom-block-span text-dark-emphasis">Location:</span>

                                <p className="mb-0 text-dark-emphasis">National Center, NYC</p>
                            </div>

                            <div className="d-flex flex-wrap align-items-center">
                                <span className="custom-block-span text-dark-emphasis">Ticket:</span>
                        ...
                        <div className="d-flex align-items-center ms-lg-auto">
                            <Link to="#" className="btn btn-secondary text-dark-emphasis">Buy Ticket</Link>
                        </div>
                    </div>
                </div>
              </div>
        ...
        <div className="row box">
          <div className='container'>
            <div className="row">
              ...
              <div className="col-sm-12 col-ms-12 col-lg-4">
                <div className="custom-block-info eventContent pe-5">
                    <Link to="#" className="events-title mb-3 text-dark-emphasis fs-2">Festival Day & Literary Marketplace</Link>
                    ...
                    <div className="d-flex flex-wrap border-top mt-4 pt-3">
                        ...
                        <div className="mb-4 mb-lg-0">
                            <div className="d-flex flex-wrap align-items-center mb-1">
                                ...
                                <p className="mb-0 text-dark-emphasis">Brooklyn Borough Hall and surrounding venues</p>
                            </div>
...
{/* -----------------------3rd row------------------------- */}
        <div className="row box">
          ...
          <div className="col-sm-12 col-ms-12 col-lg-4">
              <div className="custom-block-info eventContent pe-5">
                    <Link to="#" className="events-title mb-3 text-dark-emphasis fs-2">International Book Fair</Link>
                    ...
                    <div className="d-flex flex-wrap border-top mt-4 pt-3">
                        ...
                        <div className="mb-4 mb-lg-0">
                            <div className="d-flex flex-wrap align-items-center mb-1">
                                ...
                                <p className="mb-0 text-dark-emphasis">World Trade Center, Pasay City</p>
                            </div>
